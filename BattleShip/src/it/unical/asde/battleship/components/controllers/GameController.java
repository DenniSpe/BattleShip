...
public class GameController
{
    ...
    public Map<String, Object> checkTurn(final Optional<Integer> lobbyid, final HttpSession session)
    {
        ...
        if (user != null && lobbyid.isPresent())
        {
            ...
            if (current != null)
            {
                ...
                final List<Tupla> refreshGrid = new ArrayList<>();
                final List<Tupla> refreshGridI = new ArrayList<>();
    ...
    @ResponseBody
    public Map<String, Object> onRefreshGrid(final String lobbyID, final HttpSession session)
    {

        final User user = (User) session.getAttribute("user");

        final Lobby currentLobby = lobbyService.getLobby(Integer.parseInt(lobbyID));
        ...
        final HashMap<String, List<Tupla>> refreshGrid = new HashMap<>();
